...
from .routers import sessions, summary, details, daily_activity, weekly_activity, monthly_activity, daily_metrics
...
app.include_router(weekly_activity.router)
app.include_router(monthly_activity.router)
